...
export const MOCK_PRODUCTS: Product[] = [
  {
    ...
    description: 'Inspirado en los intrincados patrones de la Alhambra, este conjunto de ajedrez es una oda a la artesanía granadina. Cada pieza ha sido tallada a mano en ébano y arce, pulida con ceras naturales para un tacto sedoso y ancestral.\n\nEl tablero, de 45cm, presenta incrustaciones de nácar genuino, convirtiendo cada partida en un acto ritual de estrategia y belleza. Una obra de arte funcional que merece un lugar privilegiado en cualquier hogar.',
    price: 185, compare_price: 220, stock: 3, sku: 'GR-1892-CH',
    category_id: 'ajedrez',
    images: [
  ...
  },
  {
    ...
    description: 'Set completo para aventureros con pan de oro auténtico suspendido en resina cristalina. Cada dado es una pieza única, fundida a mano y pulida individualmente.\n\nCompatible con cualquier sistema de rol: D&D, Pathfinder, Vampire y más. Incluye D4, D6, D8, D10, D12, D20 y D100.',
    price: 42.50, stock: 15, sku: 'GR-2024-RD',
    category_id: 'rol',
    images: ['https://lh3.googleusercontent.com/aida-public/AB6AXuDk5JbuNDgIYeTKJ03cGaAAN6gkZG3Pr3TbaU1b7vDjINlFTP1E6m5dNFVB20IjG5MXesbnf9y86iJOng2wqtl6ewi8yuCXMbR9UGJ-kkiiCxN00QZh_-QYnJDUahc8XMQE7_vNkCFye0HI0dwYaWt2V9AcTafWqWPQUKR3LwQiWxRODAskvK1w9TlIw_uAhPsrnSffIMfZNj0t9tLHHsBySmotoF5qAcAI6F7CuMW3-ynQeCGucTCXmDullHxDjhE7dbOBiFVpGg'],
  ...
  },
  {
    ...
    description: 'Crafted from rare walnut wood. Contains two hidden chambers and a cryptic lock mechanism inspired by ancient Mongolian puzzles.\n\nSolo un 3% de compradores lo resuelve sin pistas en menos de una hora. ¿Aceptas el desafío?',
    price: 120, stock: 8, sku: 'WP-KZ-102',
    category_id: 'puzzles',
    images: ['https://lh3.googleusercontent.com/aida-public/AB6AXuAWdjN2m5W5wEVZNsRgPFU013JHDiscovGBPS0cZAA8_EKmucdULD-pYevQ89FltyqTTR5hWU9oIHrg8eXUvr05oBIMNdRVKFU0zyH6bRVmJ1Wn2w-FM2vy92qF-I60CvFF330CkD29iW9FUWyqc1TpmtGa4MMImjANoYuhmI74AHr-7qX9T_jbcdYRMrPd5AL386gABPxM7haB4f7n4Ux0ecXqzcvYmM3GPLNYYOM_-lnQ17qK-1b8mny2u262KjWkt5j3W3uTlA'],
  ...
  },
  {
    ...
    description: 'Hand-turned bone and ebony. A meticulous reconstruction of a 14th-century Cordoban chess set found in the archives of the Alhambra palace.\n\nCada una de las 32 piezas está firmada por el artesano y viene con certificado de autenticidad.',
    price: 345, stock: 2, sku: 'CS-GV-01',
    category_id: 'ajedrez',
    images: ['https://lh3.googleusercontent.com/aida-public/AB6AXuBoRr0qF7ONyX6NgMXjvzJoL3U4nwdS0_tU3AtUZJmw4TKsh5GCNk7c6yFo7rrg6GtV5LObU2bCD4Ya3OYQqQTszFuJ-sOntp7wngRXg8gnW_bPK0aVkyR-IL-nE2rdGN1iEbuG_nYESwZTzoJhTq05AZCu-hewlAdah5L7-imMI22qtF-WSvMxvQ9qHVgHFG0D7nZSyUs8gx5xD9t7wKG7vO0wydemSqrAC2wvFnw0H3ZANdbtv_wmBbRDHIgLb9s1ssr3ICCoEw'],
    difficulty: 'experto', min_players: 2, max_players: 2, min_age: 12,
  ...
  },
  {
    ...
    description: 'Semi-precious stone dice for the most demanding dungeon crawlers. Cada set incluye 7 dados tallados en cuarzo natural con incrustaciones de plata.',
    price: 45, stock: 20, sku: 'AD-SQ-24',
    category_id: 'rol',
    images: ['https://lh3.googleusercontent.com/aida-public/AB6AXuCMuyFwB9aTY8KnhS2n3Bus9197GcSE6Q8zAByDYznQxnfeYPHqTLWrqaZpJpT509w7b-IYktwyn6qk4J8eLeTlnbebjXW12whMgjPiqsVWNe3ALs2Ns7zGshJ-a6-NLJavuD0Obb4dgNXcOonZJ_LzrtU6NeKMQvqqWcG8Cyum9sC9X3hiKmcMEdtnvuBk-ly6dBdE4YH6Q82onj2SgV-Sf9GhQ5yqXI3fKB0gqfoSYp0xP9vVD2chYBo1tTKmMXVXFqz5H6LCQg'],
  ...
  },
  {
    ...
    description: 'Madera de haya maciza con piedras de resina pulida a mano. Incluye 181 piedras negras y 180 blancas en cuencos de madera torneada.',
    price: 89, stock: 4, sku: 'GO-TR-01',
    category_id: 'del-mundo',
    images: ['https://lh3.googleusercontent.com/aida-public/AB6AXuCMzY3gZbkXXGoan0CJAueBfpVyrpSxP48W34AM6HmPqZWI3HcFwDe_JEFdw5IMuUfQZDQUUtHkIFLdBVtS4xMZqatGBXpG2It0roWOAaxivhra2qRXGh38Fj0CHJcMyvxr6RzpzfWzlbDkYh_8w89HW8r1mX4C-uYXMgAhi-JTc827JI62PB9A1NTsSIo-ybOHDYhBNAQhlXX3OUt4gCTsRq5JXiEdk934jOGkfERZSqYEoDy7OAQ-TMx8gQ2KHLMoz2bIWVBzdQ'],
  ...
  },
  {
    ...
    description: 'Ilustraciones originales de 1920 recuperadas y reimpresas en cartón premium de 350g. 78 cartas con acabado mate y bordes dorados.',
    price: 35, stock: 12, sku: 'BT-ARC-20',
    category_id: 'cartas',
    images: ['https://lh3.googleusercontent.com/aida-public/AB6AXuCxxfFCxjMDaot8TtBIkyuMqD9ou2yOasTCtMMdygDEOwwDXX3fYTVKxhLjmEFJfR4XxbIqb1BwNJ9OzD5bVcH_I5l39Q8kDU17wd9ry1d9OgnS0b9KSDhjHEjGQk02Egly19ggL4bYHvmOuFdcRcHi9Je2agTENVdv1b51I29TqXSZItEfFH42YFd2bS2W4Inrn4Ee_fewbqJ9s_8ZOf83R0mICxDdnJv1ycn21wddKmDpt_TfCT31O3K93bTdXH039-JD6zTdrw'],
